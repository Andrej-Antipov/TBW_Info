# ⚡️ TBW_Info (macOS Menu Bar Utility)
---
...
**TBW Info** — это ультра-легковесный, нативный системный монитор для строки меню macOS. Приложение обеспечивает посекундный мониторинг реальной скорости записи на диски, ведет точный учет переданного объема данных за сессию и контролирует суммарный пожизненный износ накопителя (Lifetime TBW).
